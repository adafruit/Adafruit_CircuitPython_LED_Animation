...
# Patriotic
custom_colors_chase_rwb = CustomColorsChase(pixels, speed=0.1, colors=[RED, WHITE, BLUE], size=2, spacing=3)
# St Pat Day
custom_colors_chase_gw = CustomColorsChase(pixels, speed=0.1, colors=[GREEN, WHITE], size=2, spacing=3)
# Christmas
